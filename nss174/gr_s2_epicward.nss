...
//*:*  GR_S2_EPICWARD.NSS
//*:**************************************************************************
//:: Epic Ward (X2_S2_EpicWard) Copyright (c) 2003 Bioware Corp.
//:: Created By: Georg Zoeller  Created On: Aug 12, 2003
//*:**************************************************************************
...
void main() {
    ...
    int     iLimit = spInfo.iCasterLevel + 50;
    ...
    effect eProt    = EffectDamageReduction(50, DAMAGE_POWER_PLUS_TWENTY, iLimit);
