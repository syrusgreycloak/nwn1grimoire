...
//*:*  GR_S0_SHOGRASP.NSS
//*:**************************************************************************
//*:* Shocking Grasp (sg_s0_shograsp.nss) 2004 Karl Nickels (Syrus Greycloak)
...
void main() {
    ...
    int     iAttackResult   = GRTouchAttackMelee(spInfo.oTarget);
    ...
    //*:* Apply effects
    //*:**********************************************
    SignalEvent(spInfo.oTarget, EventSpellCastAt(oCaster, SPELL_SHOCKING_GRASP));
    if(iAttackResult>0) {
