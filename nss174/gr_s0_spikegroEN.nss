...
void main() {
    ...
    //*:* Apply effects
    //*:**********************************************
    location lEntryLoc = GetLocation(spInfo.oTarget);
    SetLocalLocation(spInfo.oTarget, "GR_SPIKEGROWTH_LOC_"+ObjectToString(oCaster), lEntryLoc);
    SetLocalInt(spInfo.oTarget, "GR_SPIKEGROWTH_RESISTED_"+ObjectToString(oCaster), FALSE);
