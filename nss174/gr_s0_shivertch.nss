...
void main() {
    ...
    int     iDieType          = 6;
    int     iNumDice          = (spInfo.iSpellID==SPELL_GR_LESSER_SHIVERING_TOUCH ? 1 : 3);
    int     iBonus            = 0;
    int     iDamage           = 0;
    int     iSecDamage        = 0;
    ...
    int     iVisualType     = (spInfo.iSpellID==SPELL_GR_LESSER_SHIVERING_TOUCH ? VFX_IMP_FROST_S : VFX_IMP_FROST_L);
    ...
    effect eDexDec  = EffectAbilityDecrease(ABILITY_DEXTERITY, iDamage);
    effect eDur     = EffectVisualEffect(VFX_DUR_CESSATE_NEGATIVE);
    effect eLink    = EffectLinkEffects(eDexDec, eDur);
