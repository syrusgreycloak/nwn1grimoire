...
//*:* (X2_S0_MagcWeap) Copyright (c) 2001 Bioware Corp.
...
void main() {
    ...
    //*:* int     iDieType          = 0;
    //*:* int     iNumDice          = 0;
    int     iBonus            = (spInfo.iSpellID==SPELL_MAGIC_WEAPON ? 1 : MinInt(5, spInfo.iCasterLevel/4));
    //*:* int     iDamage           = 0;
    //*:* int     iSecDamage        = 0;
    int     iDurAmount        = spInfo.iCasterLevel;
    int     iDurType          = (spInfo.iSpellID==SPELL_MAGIC_WEAPON ? DUR_TYPE_TURNS : DUR_TYPE_HOURS);
    ...
    if(GetIsObjectValid(oMyWeapon) ) {
        ...
        if(fDuration>0.0) {
            ...
            GRAddEnhancementBonusToWeapon(oMyWeapon, fDuration, iBonus);
        }
    } else {
