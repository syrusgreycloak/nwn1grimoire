...
void main() {
    ...
    string  sAOEType        = AOE_TYPE_STORM;
    ...
    //*:* Effects
    //*:**********************************************
    effect eAOE = GREffectAreaOfEffect(AOE_PER_STORM, "", "", "", sAOEType);
    /*** NWN1 SINGLE ***/ effect eVis = EffectVisualEffect(VFX_FNF_STORM);

    //*:**********************************************
    //*:* Apply effects
    //*:**********************************************
    /*** NWN1 SINGLE ***/ GRApplyEffectAtLocation(DURATION_TYPE_INSTANT, eVis, spInfo.lTarget);
    ...
    SetLocalInt(oAOE, "GR_L_STORM_ROUND_NUM", 1);
