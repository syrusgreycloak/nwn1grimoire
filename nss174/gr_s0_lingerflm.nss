...
void main() {
    ...
    int     iAOEType        = AOE_PER_FOGFIRE;
    string  sAOEType        = AOE_TYPE_FOGFIRE;
    ...
    spInfo.oTarget = GRGetFirstObjectInShape(SHAPE_SPHERE, fRange, spInfo.lTarget, iObjectType);
    ...
    while(GetIsObjectValid(spInfo.oTarget)) {
        if(GRGetIsSpellTarget(spInfo.oTarget, SPELL_TARGET_STANDARDHOSTILE, oCaster)) {
            ...
            if(!GRGetSpellResisted(oCaster, spInfo.oTarget, fDelay)) {
                ...
                SetLocalInt(spInfo.oTarget, "GR_"+IntToString(spInfo.iSpellID)+"_SRCHECKDONE", TRUE);
            } else {
                SetLocalInt(spInfo.oTarget, "GR_"+IntToString(spInfo.iSpellID)+"_RESISTED", TRUE);
            }
        }
        spInfo.oTarget = GRGetNextObjectInShape(SHAPE_SPHERE, fRange, spInfo.lTarget, iObjectType);
    }
