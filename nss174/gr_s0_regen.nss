...
//*:*  GR_S0_REGEN.NSS
//*:**************************************************************************
//*:* Regenerate (NW_S0_Regen) Copyright (c) 2001 Bioware Corp.
//*:* Created By: Preston Watamaniuk  Created On: Oct 22, 2001
//*:* 3.5 Player's Handbook (p. 270)
//*:**************************************************************************
...
void main() {
    ...
    int     iDieType          = 8;
    int     iNumDice          = 4;
    int     iBonus            = MinInt(35, spInfo.iCasterLevel);
    int     iDamage           = 0;
    //*:* int     iSecDamage        = 0;
    ...
    //*:* Apply effects
    //*:**********************************************
    SignalEvent(spInfo.oTarget, EventSpellCastAt(oCaster, SPELL_REGENERATE, FALSE));
