...
void main() {
    ...
    effect eSkillAnimal = EffectSkillIncrease(SKILL_ANIMAL_EMPATHY, 2);
    effect eHide        = EffectSkillIncrease(SKILL_HIDE, 2);
    effect eMove        = EffectSkillIncrease(SKILL_MOVE_SILENTLY, 2);
    ...
    //*:* Apply effects
    //*:**********************************************
    SignalEvent(spInfo.oTarget, EventSpellCastAt(oCaster, SPELL_ONE_WITH_THE_LAND, FALSE));
