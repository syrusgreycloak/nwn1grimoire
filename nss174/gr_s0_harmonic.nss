...
void main() {
    ...
    effect eAOE     = EffectAreaOfEffect(AOE_MOB_HARMONIC_CHORUS);

    //*:**********************************************
    //*:* Apply effects
    //*:**********************************************
    SignalEvent(spInfo.oTarget, EventSpellCastAt(oCaster, SPELL_GR_HARMONIC_CHORUS, FALSE));
    GRApplyEffectToObject(DURATION_TYPE_TEMPORARY, eDur, spInfo.oTarget, fDuration);

    GRRemoveSpellEffects(SPELL_GR_HARMONIC_CHORUS, oCaster);
    SignalEvent(oCaster, EventSpellCastAt(oCaster, SPELL_GR_HARMONIC_CHORUS, FALSE));
    GRApplyEffectToObject(DURATION_TYPE_TEMPORARY, eAOE, oCaster, fDuration);
    object oAOE = GRGetAOEOnObject(oCaster, AOE_TYPE_HARMONIC_CHORUS, oCaster);
