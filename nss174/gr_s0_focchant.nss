...
void main() {
    ...
    effect eAbility = GREffectAbilityCheckIncrease(iBonus);
    ...
    //*:* Apply effects
    //*:**********************************************
    GRRemoveSpellEffects(SPELL_GR_FOCUSING_CHANT, oCaster);
    SignalEvent(oCaster, EventSpellCastAt(oCaster, SPELL_GR_FOCUSING_CHANT, FALSE));
