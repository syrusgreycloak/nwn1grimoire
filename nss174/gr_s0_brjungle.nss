...
//*:*  GR_S0_BRJUNGLE.NSS
//*:**************************************************************************
//*:* Breath of the Jungle   2006 Karl Nickels (Syrus Greycloak)
...
void main() {
    ...
    int     iAOEType        = AOE_PER_BREATH_JUNGLE;
    string  sAOEType        = AOE_TYPE_BREATH_JUNGLE;
    ...
    if(GRGetMetamagicUsed(spInfo.iMetamagic, METAMAGIC_WIDEN)) {
        iAOEType = AOE_PER_BREATH_JUNGLE_WIDE;
        sAOEType = AOE_TYPE_BREATH_JUNGLE_WIDE;
    }
    ...
    GRSetAOESpellId(SPELL_GR_BREATH_OF_THE_JUNGLE, oAOE);
