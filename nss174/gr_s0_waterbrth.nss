...
//*:*  GR_S0_WATERBRTH.NSS
//*:**************************************************************************
//*:* Water Breathing (sg_s0_waterbrth.nss) 2004 Karl Nickels (Syrus Greycloak)
...
void main() {
    ...
    //*:* Apply effects
    //*:**********************************************
    SignalEvent(spInfo.oTarget, EventSpellCastAt(oCaster, SPELL_GR_WATER_BREATHING, FALSE));
    GRApplyEffectToObject(DURATION_TYPE_INSTANT, eImpVis, spInfo.oTarget);
    GRApplyEffectToObject(DURATION_TYPE_TEMPORARY, eLink, spInfo.oTarget, fDuration);
    GRApplySpecialEffectToObject(DURATION_TYPE_TEMPORARY, SPECIALEFFECT_TYPE_WATER_BREATHING, spInfo.oTarget, fDuration);
