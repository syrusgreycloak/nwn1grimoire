...
//*:*  GR_S0_SOLIPSISM.NSS
//*:**************************************************************************
//*:* Solipsism (nx_s0_solipsism.nss) Copyright (c) 2007 Obsidian Entertainment, Inc.
//*:* Created By: Andrew Woo (AFW-OEI)  Created On: 05/07/2007
//*:**************************************************************************
...
void main() {
    ...
    /*** END NWN1 SPECIFIC ***/
    //*** NWN2 SINGLE ***/ effect eParal = EffectParalyze(spInfo.iDC, SAVING_THROW_WILL, FALSE);
