...
//*:*  GR_S0_VINEMCAM.NSS
//*:**************************************************************************
//:: Vine Mine, Camouflage (X2_S0_VineMCam) Copyright (c) 2001 Bioware Corp.
...
void main() {
    ...
    int     iAOEType        = 40;
    string  sAOEType        = AOE_TYPE_CAMOUFLAGE;
    ...
    if(GRGetMetamagicUsed(spInfo.iMetamagic, METAMAGIC_WIDEN)) {
        iAOEType = AOE_PER_CAMOUFLAGE_WIDE;
        sAOEType = AOE_TYPE_CAMOUFLAGE_WIDE;
    }
    ...
    //*:* Effects
    //*:**********************************************
    effect eAOE = GREffectAreaOfEffect(40);
