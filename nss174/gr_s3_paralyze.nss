...
//*:*  GR_S3_PARALYZE.NSS
//*:**************************************************************************
//*:* OnHitCastSpell Misc Effects (x2_s3_paralyze) Copyright (c) 2003 Bioware Corp.
//*:* Created By: Georg Zoeller  Created On: 2003-09-18
...
void main() {
    ...
    if(GetIsObjectValid(oItem)) {
        if(!GetHasSpellEffect(spInfo.iSpellID, spInfo.oTarget)) {
            if(GRDoCubeParalyze(spInfo.oTarget, oCaster, spInfo.iDC)) {
                FloatingTextStrRefOnCreature(84609, spInfo.oTarget);
            } else {
