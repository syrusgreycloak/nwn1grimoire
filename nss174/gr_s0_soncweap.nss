...
void main() {
    ...
    itemproperty ipColdDamage = ItemPropertyDamageBonus(IP_CONST_DAMAGETYPE_SONIC, iIPDmgBonus);

    if(GetObjectType(spInfo.oTarget)==OBJECT_TYPE_ITEM) {
        spInfo.oTarget = GetItemPossessor(spInfo.oTarget);
    }
    ...
    if(GetIsObjectValid(oMyWeapon)) {
        GRIPSafeAddItemProperty(oMyWeapon, ItemPropertyVisualEffect(ITEM_VISUAL_SONIC), fDuration);
