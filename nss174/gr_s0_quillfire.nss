...
//*:*  GR_S0_QUILLFIRE.NSS
//*:**************************************************************************
//*:* Quillfire [x0_s0_quillfire.nss] Copyright (c) 2002 Bioware Corp.
//*:* Created By: Brent  Created On: July 17 2002
//*:* Spell Compendium (p. 164)
//*:**************************************************************************
...
void main() {
    ...
    int     iDieType          = 8;
    int     iNumDice          = 1;
    int     iBonus            = MaxInt(0, MinInt(5, spInfo.iCasterLevel/2));
    int     iDamage           = 0;
    int     iSecDamage        = 0;
    ...
    int     iWisMod         = GetAbilityModifier(ABILITY_WISDOM, oCaster);
    int     iPoisonType     = ((iWisMod+13)>18 ? POISON_PURPLE_WORM_POISON : POISON_LARGE_SPIDER_VENOM);
    ...
    //*:**********************************************
    if(iDamage>0) {
        SignalEvent(spInfo.oTarget, EventSpellCastAt(oCaster, SPELL_QUILLFIRE));
        GRApplyEffectToObject(DURATION_TYPE_INSTANT, eDam, spInfo.oTarget);
        GRApplyEffectToObject(DURATION_TYPE_INSTANT, eVis, spInfo.oTarget);
        GRApplyEffectToObject(DURATION_TYPE_PERMANENT, ePoison, spInfo.oTarget);
    }
