//*:**************************************************************************
//*:*  GR_S0_CREAKCPHYB.NSS
//*:**************************************************************************
//*:* Creaking Cacophony (OnExit)
...
void main() {
    ...
    //*:* Apply effects
    //*:**********************************************
    GRRemoveSpellEffects(SPELL_GR_CREAKING_CACOPHONY, spInfo.oTarget);
    if(GetLocalInt(spInfo.oTarget, "GR_CREAK_DMGVULN")) {
        ...
        if(GetIsObjectValid(oHide)) {
            IPRemoveMatchingItemProperties(oHide, ITEM_PROPERTY_DAMAGE_VULNERABILITY, DURATION_TYPE_PERMANENT);
        }
    }
