...
//*:*  GR_S0_SYNOSTODW.NSS
//*:**************************************************************************
//*:* (The Simbul's) Synostodweomer (sg_s0_simsynost.nss) 2004 Karl Nickels (Syrus Greycloak)
//*:* Created By: Karl Nickels (Syrus Greycloak)  Created On: August 9, 2004
//*:* Spell Compendium (p. 218)
//*:**************************************************************************
...
void main() {
    ...
    //*:* Apply effects
    //*:**********************************************
    SignalEvent(spInfo.oTarget, EventSpellCastAt(oCaster, SPELL_GR_SIMBULS_SYNOSTODWEOMER, FALSE));
    ...
    SetLocalInt(oCaster, "SIMBULS_SYNOST_MM", spInfo.iMetamagic);
