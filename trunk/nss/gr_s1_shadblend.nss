...
//*:*  GR_S1_SHADBLEND.NSS
//*:**************************************************************************
//*:* Shadow Dragon: Blend into shadows (x2_s1_shadblend) Copyright (c) 2003 Bioware Corp.
//*:* Created By: Georg Zoeller  Created On: 2003-08-27
//*:**************************************************************************
/*

   The shadow dragons blend into shadows ability.
   Will give him 9/10th concealment
...
void main() {
    ...
    if(!GetHasSpellEffect(spInfo.iSpellID, oCaster)) {
        ...
        if(!GetHasSpellEffect(SPELL_CONTINUAL_FLAME, oCaster)) {
