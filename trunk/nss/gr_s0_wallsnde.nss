...
//*:*  GR_S0_WALLSNDE.NSS
//*:**************************************************************************
//*:* Wall of Sound: On Enter (within 30 ft - can't communicate or talk)
...
void main() {
    ...
    GRApplyEffectToObject(DURATION_TYPE_INSTANT, eSilenceVis, spInfo.oTarget);
    GRApplyEffectToObject(DURATION_TYPE_PERMANENT, eSilence, spInfo.oTarget);
