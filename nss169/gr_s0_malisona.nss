...
//*:*  GR_S0_MALISONA.NSS
//*:**************************************************************************
//*:* Lesser (Minor) Malison: OnEnter
//*:* Greater Malison: OnEnter
//*:* 2E Tome of Magic
//*:**************************************************************************
...
void main() {
    ...
    //*:* int     iDieType          = 0;
    //*:* int     iNumDice          = 0;
    int     iBonus            = (spInfo.iSpellID==SPELL_GR_LESSER_MALISON ? 1 : 2);
    //*:* int     iDamage           = 0;
    //*:* int     iSecDamage        = 0;
    ...
    if(GRGetIsSpellTarget(spInfo.oTarget, SPELL_TARGET_STANDARDHOSTILE, oCaster)) {
        ...
        if(!GRGetSpellResisted(oCaster, spInfo.oTarget)) {
            ...
            GRApplyEffectToObject(DURATION_TYPE_PERMANENT, eSavePenalty, spInfo.oTarget);
        }
    }
