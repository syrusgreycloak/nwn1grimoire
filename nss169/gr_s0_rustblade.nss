...
void main() {
    ...
    itemproperty ipDisease = ItemPropertyOnHitProps(IP_CONST_ONHIT_DISEASE, spInfo.iDC, DISEASE_FILTH_FEVER);
    ...
    if(GetIsObjectValid(oMyWeapon)) {
        ...
        if(fDuration>0.0) {
            ...
            GRIPSafeAddItemProperty(oMyWeapon, ipDisease, fDuration);
        }
        return;
     } else {
