...
void main() {
    ...
    int     iAOEType        = AOE_PER_SNOWSONG;
    string  sAOEType        = AOE_TYPE_SNOWSONG;
    ...
    if(GRGetMetamagicUsed(spInfo.iMetamagic, METAMAGIC_WIDEN)) {
        iAOEType = AOE_PER_SNOWSONG_WIDE;
        sAOEType = AOE_TYPE_SNOWSONG_WIDE;
    }
    ...
    GRApplyEffectAtLocation(DURATION_TYPE_INSTANT, eImp, GetLocation(oCaster));
