//*:**************************************************************************
//*:*  GR_S3_SUMMONELEM.NSS
//*:**************************************************************************
//*:* Summon Huge Elemental (x0_s3_summonelem) Copyright (c) 2002 Floodgate Entertainment
//*:* Created By: Nathaniel Blumberg  Created On: 12/13/02
//*:**************************************************************************
...
void main() {
    ...
    float   fDuration       = GRGetDuration(iDurAmount, iDurType) + GRGetDuration(1);
    //*:* float   fDelay          = 0.0f;
    ...
    //*:* Apply effects
    //*:**********************************************
    if(!GRGetIsUnderwater(oCaster) && !(spInfo.iCasterLevel==1 || spInfo.iCasterLevel==4)) {
