...
void main() {
    ...
    int     iACIncrease     = MinInt(8, 3+spInfo.iCasterLevel/4);
    ...
    //*:* Apply effects
    //*:**********************************************
    SignalEvent(spInfo.oTarget, EventSpellCastAt(oCaster, SPELL_GR_ARMOR_DARKNESS, FALSE));
    GRRemoveSpellEffects(SPELL_GR_ARMOR_DARKNESS, spInfo.oTarget);
