...
//*:*  GR_S0_ETHERBAR.NSS
//*:**************************************************************************
//*:* Ethereal Barrier (sg_s0_etherbar.nss) 2004 Karl Nickels (Syrus Greycloak)
...
void main() {
    ...
    int     iAOEType        = AOE_PER_ETHEREAL_BARRIER;
    string  sAOEType        = AOE_TYPE_ETHEREAL_BARRIER;
    ...
    if(GRGetMetamagicUsed(spInfo.iMetamagic, METAMAGIC_WIDEN)) {
        iAOEType = AOE_PER_ETHEREAL_BARRIER_WIDE;
        sAOEType = AOE_TYPE_ETHEREAL_BARRIER_WIDE;
    }
    ...
    GRSetAOESpellId(spInfo.iMetamagic, oAOE);
