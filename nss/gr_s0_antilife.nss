...
void main() {
    ...
    effect eAOE     = GREffectAreaOfEffect(AOE_MOB_ANTILIFE_SHELL);
    effect eLink    = EffectLinkEffects(eDur, eAOE);

    //*:**********************************************
    //*:* Apply effects
    //*:**********************************************
    SignalEvent(oCaster, EventSpellCastAt(oCaster, SPELL_GR_ANTILIFE_SHELL, FALSE));
    ...
    object oAOE = GRGetAOEOnObject(oCaster, AOE_TYPE_ANTILIFE_SHELL, oCaster);
