...
//*:**************************************************************************
//*:*
//*:* Blackstaff (X2_S0_Blckstff) Copyright (c) 2001 Bioware Corp.
//*:*
//*:**************************************************************************
    ...
    if(GetIsObjectValid(oMyWeapon)) {
        ...
        if(GetBaseItemType(oMyWeapon) == BASE_ITEM_QUARTERSTAFF) {
            if(fDuration>0.0) {
                ...
                GRAddBlackStaffEffectOnWeapon(oMyWeapon, fDuration);
            }
            return;
        } else {
           FloatingTextStrRefOnCreature(83620, oCaster);  // not a qstaff
           return;
        }
    } else {
