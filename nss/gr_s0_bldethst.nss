...
//*:**************************************************************************
//*:*
//*:* Blade Thrist (X2_S0_BldeThst) Copyright (c) 2001 Bioware Corp.
//*:*
//*:**************************************************************************
    ...
    if(GetIsObjectValid(oMyWeapon)) {
        ...
        if(GetSlashingWeapon(oMyWeapon)) {
            if(fDuration>0.0) {
                ...
                GRAddBladeThirstEffectToWeapon(oMyWeapon, fDuration);
            }
            return;
        } else {
          FloatingTextStrRefOnCreature(83621, oCaster); // not a slashing weapon
          return;
        }
     } else {
