...
//*:*  GR_S3_HERB.NSS
//*:**************************************************************************
//*:* NW_S3_HERB.nss  Copyright (c) 2001 Bioware Corp.
//*:**************************************************************************
...
void main() {
    ...
    switch(spInfo.iSpellID) {
        case 409: // Belladonna
            ...
            GRApplyEffectToObject(DURATION_TYPE_TEMPORARY, eACBonus, spInfo.oTarget, 60.0);
            break;
        case 410: // Garlic
            GRApplyEffectToObject(DURATION_TYPE_PERMANENT, eVisual, spInfo.oTarget);
            GRApplyEffectToObject(DURATION_TYPE_TEMPORARY, eAttackBonus, spInfo.oTarget, 60.0);
            GRApplyEffectToObject(DURATION_TYPE_TEMPORARY, eCharisma, spInfo.oTarget, 60.0);
            break;
    }
