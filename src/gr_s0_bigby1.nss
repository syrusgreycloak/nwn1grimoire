...
//*:**************************************************************************
//*:*
//*:* Bigby's Interposing Hand [x0_s0_bigby1] Copyright (c) 2001 Bioware Corp.
//*:*
//*:**************************************************************************
//*:* Created By: Brent
...
void main() {
    ...
    //*:* Effects
    //*:**********************************************
    effect eAC1     = EffectAttackDecrease(iBonus, AC_DODGE_BONUS);
    ...
    if(GRGetIsSpellTarget(spInfo.oTarget, SPELL_TARGET_STANDARDHOSTILE, oCaster, FALSE)) {
        SignalEvent(spInfo.oTarget, EventSpellCastAt(oCaster, SPELL_BIGBYS_INTERPOSING_HAND));
