...
//*:*  GR_S0_EVARDS.NSS
//*:**************************************************************************
//*:* Evards Black Tentacles (NW_S0_Evards.nss) Copyright (c) 2001 Bioware Corp.
...
void main() {
    ...
    int     iAOEType        = AOE_PER_EVARDS_BLACK_TENTACLES;
    string  sAOEType        = AOE_TYPE_EVARDS_BLACK_TENTACLES;
    ...
    if(GRGetMetamagicUsed(spInfo.iMetamagic, METAMAGIC_WIDEN)) {
        iAOEType = AOE_PER_EBLACK_TENTACLES_WIDE;
        sAOEType = AOE_TYPE_EBLACK_TENTACLES_WIDE;
    }
