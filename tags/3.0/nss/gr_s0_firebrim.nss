...
void main() {
    ...
    effect eLink    = EffectLinkEffects(eDamage, eVis1);
    eLink = EffectLinkEffects(eLink, eVis2);

    effect eSicken  = GREffectSickened();
    effect eDur     = EffectVisualEffect(VFX_DUR_CESSATE_NEGATIVE);
    effect eLink2   = EffectLinkEffects(eSicken, eDur);

    //*:**********************************************
    //*:* Apply effects
    //*:**********************************************
    SignalEvent(spInfo.oTarget, EventSpellCastAt(oCaster, SPELL_GR_FIRE_AND_BRIMSTONE));
