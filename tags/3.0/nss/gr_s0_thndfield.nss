...
void main() {
    ...
    effect eAOE     = EffectAreaOfEffect(AOE_PER_THUNDER_FIELD);
    ...
    object oAOE = GRGetAOEAtLocation(spInfo.lTarget, AOE_TYPE_THUNDER_FIELD, oCaster);
    GRSetAOESpellId(spInfo.iSpellID, oAOE);
    GRSetSpellInfo(spInfo, oAOE);
    SetLocalInt(oAOE, "GR_ENERGY_"+IntToString(spInfo.iSpellID)+"_"+ObjectToString(oCaster), iEnergyType);
